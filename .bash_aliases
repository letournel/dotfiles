...
alias docker-router-check='docker exec -ti system_router_1 cat /etc/nginx/conf.d/staging.conf | sed '\''/^\s*$/d'\'''
alias docker-router-restart='docker exec -ti system_router_1 /etc/init.d/nginx restart'
alias docker-rm-all='docker rm -fv $(docker ps -a -q)'
alias docker-rm-exited='docker rm -fv $(docker ps -a -q -f status=exited)'
